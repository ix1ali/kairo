...
export default function NotFound() {
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-5 text-center">
      ...
      <div className="pointer-events-none absolute left-1/2 top-1/3 h-[24rem] w-[44rem] -translate-x-1/2 rounded-full bg-[#6D4DF6]/14 blur-[120px]" />
      <div className="relative">
        ...
        <p className="mx-auto mt-3 max-w-sm text-[14px] leading-relaxed text-[#6B6678]">
